...
public class CaptureHeartRate extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capture_heart_rate);
        v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        parentReference=this;
        strSavedDoctorID= CaptureHeartRate.this.getSharedPreferences("app_prefs", MODE_PRIVATE)
                .getString("doc_id", "---");
    ...
    private static void showReadingCompleteDialog(){
        ...
        builder.setMessage("Reading taken Succesfully - " + beatsPerMinuteValue + " beats per minute.")
                .setCancelable(false)
                .setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent retIntent = new Intent();
                        retIntent.putExtra("heart_rate", Integer.valueOf(beatsPerMinuteValue));
                        ( (Activity) parentReference).setResult(RESULT_OK, retIntent);
